...
const paths_loader = {
  ...
  to: document.getElementById('from_morph').getAttribute('d'),
}

const compiled_loader = compile([
  paths_loader.botLeft,
  paths_loader.botRight
])
...
paths_loader.from.parentNode.addEventListener('click', function(e){
  alert(1);
})
